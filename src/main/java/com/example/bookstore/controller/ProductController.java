...
public class ProductController {
    ...
    public Product getProductById(
            @Parameter(description = "ID of the product to retrieve", example = "201")
            @PathVariable int id) {
    ...
    public Product updateProduct(
            @Parameter(description = "ID of the product to update", example = "201")
            @PathVariable int id,
    ...
    public void deleteProduct(
            @Parameter(description = "ID of the product to delete", example = "201")
            @PathVariable int id) {
        service.delete(id);
    }
}